...
export function createProjects(): Project[] {
    return [
        ...
        makeProject(3, '743⁺Aether*✧ . * ¹¹¹} ⁺ , .', 'aether', placeHolderHTML, 'Experiences', ['C#', 'Shaders', 'Unity']),
        ...
        makeProject(3, 'My Website', 'my-website', placeHolderHTML, 'Experiences', ['TypeScript']),
        ...
        makeProject(1.5, 'Music Sketch Catalogue', 'music-sketch-catalogue', placeHolderHTML, 'Experiments', ['TypeScript']),
