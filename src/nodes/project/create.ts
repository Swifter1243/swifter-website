...
const projects: Project[] = [
    ...
    },
    {
        ...
        page: PAGES.beatSaberEnvironmentGrabber,
        category: 'Tools',
        skills: ['TypeScript'],
    ...
    },
    {
        ...
        page: PAGES.excelSoftwareRenderer,
        category: 'Experiments',
    ...
    },
    {
        ...
        page: PAGES.unityAnimationWindow,
        category: 'Tools',
        skills: ['Unity', 'C#'],
