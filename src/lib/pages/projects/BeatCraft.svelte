...
<div class="descripted-item">
    <div class="content-row">
        <YoutubeVideo videoId="dnoKyY3HeP8" width="80%"/>
        <YoutubeVideo videoId="LCD4xWgQez4" width="80%"/>
    </div>
...
<RedditVideo path="r/Minecraft/comments/l4w7of/working_on_making_beat_saber_in_minecraft/" />
...
<div class="content-pair-right">
    <div class="descripted-item">
        <YoutubeVideo videoId="DVfEUFvL14I" />
